...
app = FastAPI(title="YOLO HTTP Inference Service")
...
def infer_output_to_dict(out) -> dict:
    return {
        ...
        "yolo_txt": out.yolo_txt,
        "annotated_image_base64": base64.b64encode(out.annotated_image_bytes).decode("utf-8"),
        "annotated_media_type": out.annotated_media_type,
    }
